...
public class HistorialAdapter extends RecyclerView.Adapter<HistorialAdapter.ViewHolder> {
    ...
    HistorialAdapter.OnItemClickListener listener;
    public interface OnItemClickListener {
        void onItemClick(Solicitud solicitud);
    }

    public HistorialAdapter(List<Solicitud> solicitudes, HistorialAdapter.OnItemClickListener listener) {
    ...
    public HistorialAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.holder_historial, null);
        HistorialAdapter.ViewHolder holder = new HistorialAdapter.ViewHolder(layoutView);
        return holder;
    }
